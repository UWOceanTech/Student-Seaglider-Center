...
% edited Bella Loeffler (07/17/2026)
...
id_str = '175';
mission_title ='2026_07_17_TasmanX_test';
% TasmanX Test
% Last edited 16 July 2026 by Bella Loeffler
% Katie added % FM_ignore 25 may 2026
mass = 51.742; % (kg) scale weight value updated 16 July 2026
% Optional
%PARAM mass_comp = 0;
...
% Oxygen cal constants	(17July2026 BL)			
% The values below are not fully updated. They were copied in as an example from sg195
optode_st_calphase = 30.394; % p1750095.eng
optode_st_temp = 15.822; % p1750095.eng
optode_st_slp = 1017.00; % paine field 07/17/2026
